...
export default {
    data() {
        return {
            title: "我是問卷名稱",
            description: "我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明我是問卷說明",
    ...
    <div class="survey">
        ...
        <div class="basicInfo border">
            ...
            <div class="time border">
                ...
                <span v-text="this.startDate"></span> <br>
                <label for="">結束日期</label> &nbsp;
                <span v-text="this.endDate"></span> <br>
            </div>
        </div>
        ...
        <div class="btn border">
            <router-link class="router" to="/create">
                <button class="btnL" type="button">編輯</button>
            </router-link>
            <router-link class="router" to="/adminHome">
                <button class="btnM" type="button">儲存</button>
            </router-link>
            <router-link class="router" to="/adminHome">
